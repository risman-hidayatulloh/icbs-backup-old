...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2018 at 07:42 AM
...
(23, 'Pengeluaran', 'jenis_pembayaran', 'fa fa-credit-card', 35),
...
(29, 'Laporan', 'keuangan', 'fa fa-desktop', 35),
(30, 'Laporan', 'keuangan', 'fa fa-desktop', 0),
(31, 'Penerimaan', 'jenis_pembayaran', 'fa fa-credit-card', 0),
(32, 'Pemasukan', 'jenis_pemasukan', 'fa fa-credit-card', 36),
(33, 'Biaya Pemasukan', 'pemasukan/setup', 'fa fa-graduation-cap', 36),
(34, 'Laporan', 'pemasukan', 'fa fa-desktop', 36),
...
--
ALTER TABLE `tbl_jenis_pemasukan`
  MODIFY `id_jenis_pemasukan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_user_rule`
  MODIFY `id_rule` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
