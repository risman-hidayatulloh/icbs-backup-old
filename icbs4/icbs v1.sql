...
(3, '2018-08-07', '', 11, 100000, ''),
(4, '2018-08-07', '', 10, 500, 'Uang Keluar'),
(5, '2018-08-10', '1', 12, 2, '2'),
(6, '2018-08-07', '1602474', 12, 500, 'Uang Masuk');
...
--
ALTER TABLE `tbl_user_rule`
  MODIFY `id_rule` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
