...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php
            echo form_open('keuangan2/setup');
            ?>
            <table class="table table-bordered">
                <?php
                foreach ($jenis_pemasukan->result() as $row) {
                    echo "<tr>
                        <td width='200'>" . strtoupper($row->nama_jenis_pemasukan) . "</td>
                        <td><input type='int' value='".  chek_komponen_biaya_pemasukan($row->id_jenis_pemasukan)."' class='form-control' name='$row->id_jenis_pemasukan' placeholder='Masukan Data $row->nama_jenis_pemasukan'></td></tr>";
                }
                ?>
