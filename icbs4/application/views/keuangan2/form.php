<div class="col-md-6">
    ...
    <div class="panel panel-default">
        <?php echo form_open('keuangan2/form'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
                ...
                <tr><td>JENIS PEMASUKAN</td><td><?php echo cmb_dinamis('jenis_pemasukan', 'tbl_jenis_pemasukan', 'nama_jenis_pemasukan', 'id_jenis_pemasukan')?></td></tr>
                <tr><td>JUMLAH PEMASUKAN</td><td><input type="int" name="jumlah_pemasukan" placeholder="JUMLAH" class="form-control"></td></tr>
    ...
    <!-- end: DYNAMIC TABLE PANEL -->
        ...
        <script type="text/javascript">
            function isi_otomatis(){
                var nis = $("#nis").val();
                $.ajax({
                    url: '<?php echo base_url()?>index.php/keuangan2/form_siswa_autocomplate',
                    data:"nis="+nis ,
